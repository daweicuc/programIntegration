...
/**
 * @ClassName OracleJDBCMapper
 * @Description TODO
 * @Author Mike
 * @Date 2019/6/2 18:30
 * @Version 1.0
 */
public class OracleJDBCMapper {
    // 定义连接所需的字符串
    // 192.168.0.X是本机地址(要改成自己的IP地址)，1521端口号，XE是精简版Oracle的默认数据库名
    private static String USERNAMR = "UOP_ACT1";
    private static String PASSWORD = "m_y3xdtz";
    private static String DRVIER = "oracle.jdbc.OracleDriver";
    private static String URL = "jdbc:oracle:thin:@132.80.241.214:11523:ngact";
    ...
    public void SelectData() {
        connection = getConnection();
        String sql = "select * from tf_f_user where serial_number='15601354456'";
        try {
            pstm = connection.prepareStatement(sql);
            rs = pstm.executeQuery();
            while (rs.next()) {
