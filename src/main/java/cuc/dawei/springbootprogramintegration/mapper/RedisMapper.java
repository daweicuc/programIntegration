...
import cuc.dawei.springbootprogramintegration.tools.RedisUtil;
...
public class RedisMapper {
    ...
    public void testSet() {
        ...
        System.out.println(jedis.sismember("userS", "who"));//判断who是否是user集合的元素
    ...
    public static void main(String[] args) {
        RedisMapper test = new RedisMapper();
        test.connectRedis();
        test.testSort();
        test.testList();
        test.testMap();
